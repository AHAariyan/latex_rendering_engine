...
pub static SYMBOLS: &[(&str, char, AtomType)] = &[
    ...
    ("lmoustache", '⎰', Open),
    ("rmoustache", '⎱', Close),
    // AMS and other symbols, brought to parity with KaTeX's table.
    ("And", '&', Bin),
    ("Cap", '⋒', Bin),
    ("Cup", '⋓', Bin),
    ("Doteq", '≑', Rel),
    ...
    ("barwedge", '⊼', Bin),
    ("bigcirc", '◯', Bin),
    ("blacktriangleleft", '◀', Rel),
    ("blacktriangleright", '▶', Rel),
    ("circledR", '®', Ord),
    ("curlyeqprec", '⋞', Rel),
    ("curlyeqsucc", '⋟', Rel),
    ("curlyvee", '⋎', Bin),
    ...
    ("veebar", '⊻', Bin),
    ("yen", '¥', Ord),
    // Aliases people expect from HTML entities, amsmath and KaTeX.
    ("lparen", '(', Open),
    ("rparen", ')', Close),
    ("lang", '⟨', Open),
    ("rang", '⟩', Close),
...
pub static FN_NAMES: &[(&str, bool)] = &[
    ...
    ("varlimsup", true),
    ("plim", true),
    // Function names used in French, German, Russian and other traditions.
    ("ch", false),
    ("sh", false),
    ("th", false),
    ("tg", false),
...
/// Accents and their combining code points: `(name, char, stretchy, under)`.
pub static ACCENTS: &[(&str, char, bool, bool)] = &[
    ("hat", '\u{0302}', false, false),
    ("widehat", '\u{0302}', true, false),
    ("tilde", '\u{0303}', false, false),
    ("widetilde", '\u{0303}', true, false),
    ("bar", '\u{0304}', false, false),
    ("vec", '\u{20D7}', false, false),
    ("dot", '\u{0307}', false, false),
    ("ddot", '\u{0308}', false, false),
    ("dddot", '\u{20DB}', false, false),
    ("acute", '\u{0301}', false, false),
    ("grave", '\u{0300}', false, false),
    ("breve", '\u{0306}', false, false),
    ("check", '\u{030C}', false, false),
    ("mathring", '\u{030A}', false, false),
    ("overrightarrow", '\u{20D7}', true, false),
    ("overleftarrow", '\u{20D6}', true, false),
    ("underrightarrow", '\u{20EF}', true, true),
    ("underleftarrow", '\u{20EE}', true, true),
    ("underleftrightarrow", '\u{034D}', true, true),
    ("undergroup", '\u{23DD}', true, true),
    ("underlinesegment", '\u{23B5}', true, true),
    ("utilde", '\u{0330}', true, true),
    ("overleftrightarrow", '\u{20E1}', true, false),
    ("Overrightarrow", '\u{20D7}', true, false),
    ("overgroup", '\u{23DC}', true, false),
    ("overlinesegment", '\u{23B4}', true, false),
    ("overleftharpoon", '\u{20D0}', true, false),
    ("overrightharpoon", '\u{20D1}', true, false),
    ("widecheck", '\u{030C}', true, false),
    ("widebreve", '\u{0306}', true, false),
];
